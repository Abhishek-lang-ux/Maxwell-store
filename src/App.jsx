...
function App() {
  ...
  const filteredProducts = useMemo(() => {
    ...
    return products.filter((product) => {
      const matchesCategory = activeCategory === "All" || product.category === activeCategory || product.categoryGroup === activeCategory;
      const haystack = `${product.name} ${product.model} ${product.category} ${product.spec}`.toLowerCase();
